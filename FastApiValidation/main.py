...
# ===================================================================
# list[BookResopnse] is used because we return all the books record
# ==================================================================
@app.get('/books', response_model=list[BookResopnse])
def get_books():
    return books
...
# ============================================================
@app.get('/books/{book_id}', response_model=BookResopnse)
...
# ======================================================
@app.post('/books', response_model=BookActionResponse,status_code=201)
